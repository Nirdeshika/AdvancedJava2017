...
public class Project1 {
    ...
    public static void main(String[] args) {
        ...
        try {
            flightNumber = Integer.parseInt(args[1 + numberOfOptions]);
        } catch (NumberFormatException nfe) {
            System.out.println("Invalid number: " + args[1 + numberOfOptions] + ". Please enter a valid flight number.");
            System.exit(2);
        }
    ...
    private static String getReadMe() {
        ...
        readMe += "Purpose of the project: This project parses command line arguments to check for the validity of the values. " +
                ...
                "This project also takes two options: -README prints a brief description of what the project does.\n" +
     ...
     * @exception ErroneousNumberOfArgumentsException
     */
     ...
     * @exception IllegalAirportCodeException
     */
    private static void checkAirportCodeFormat(String airportCode) {
        if (!airportCode.matches("[a-zA-z][a-zA-Z][a-zA-Z]"))
            throw new IllegalAirportCodeException("Please check. Not a valid airport code: " + airportCode);
    }
     ...
     * @exception ErroneousDateTimeFormatException
     */
